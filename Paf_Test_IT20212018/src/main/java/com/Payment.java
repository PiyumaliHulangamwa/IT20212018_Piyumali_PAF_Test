...
private Connection connect() 
 ...
 "jdbc:mysql://127.0.0.1:3306/power", "root", "1234"); 
 } 
 catch (Exception e) 
 { 
 e.printStackTrace(); 
...
public String readP() { 
 ...
 output = "<table border='1'><tr><th>Name</th> <th>District</th> <th>Units</th> <th>Dues</th> <th>Date</th> <th>Update</th><th>Remove</th></tr>"; 
...
public String insertP(String p_name, String p_district, String p_units, String p_dues, String p_date) { 
 String output = ""; 
 try { 
 Connection con = connect(); 
 if (con == null) 
 ...
 con.close(); 
 String newP = readP(); 
 output = "{\"status\":\"success\", \"data\": \"" + newP + "\"}"; 
 } 
 catch (Exception e) 
 { 
...
public String updateP(String ID, String p_name, String p_district, String p_units, String p_dues, String p_date) 
 { 
 String output = ""; 
 try
 { 
...
public String deleteP(String userID) 
 { 
 String output = ""; 
 try
 { 
